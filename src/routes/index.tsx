    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden bg-[#fffaf3] px-4 py-14 sm:py-20">
        ...
        <Reveal className="relative mx-auto max-w-6xl">
          <div className="mx-auto max-w-2xl text-center">
            <span className="inline-flex items-center gap-2 rounded-full bg-cta/10 px-4 py-2 text-xs font-extrabold uppercase tracking-wider text-cta-dark"><Star className="size-4 fill-gold text-gold" /> Relatos reais</span>
            <h2 className="mt-4 text-3xl font-extrabold sm:text-4xl">Quem recebeu o material conta como foi</h2>
            <p className="mt-3 leading-7 text-muted-foreground">Depoimentos enviados por clientes após receberem e utilizarem o material.</p>
          </div>
      ...
      <section id="ofertas" className="scroll-mt-16 bg-secondary px-4 py-14 sm:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="mx-auto w-fit rounded-full bg-alert px-5 py-2 text-center text-sm font-bold text-alert-foreground">
            <span className="inline-flex items-center gap-2"><Clock className="size-4" /> Escolha o pacote que combina com você</span>
          </div>
      ...
      <section className="bg-gradient-brand px-4 py-14 text-center text-brand-foreground sm:py-20">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-4 text-brand-foreground/90">+ de 30 livros digitais para imprimir quando quiser, com acesso conforme as condições da oferta.</p>
          <div className="mx-auto mt-8 max-w-sm space-y-3">
            <CTA href={CHECKOUT_PREMIUM}>Quero o pacote premium — R$ 19,90</CTA>
            <a href={CHECKOUT_BASICO} className="block rounded-full border-2 border-white/40 px-6 py-3.5 text-sm font-extrabold uppercase tracking-wide">Prefiro o básico — R$ 8,90</a>
          </div>
        </div>
      </section>
      ...
      <div className="sticky bottom-0 z-30 border-t border-border bg-background/95 p-3 backdrop-blur lg:hidden">
        <CTA href="#ofertas" className="py-3.5 text-sm">Ver ofertas a partir de R$ 8,90</CTA>
      </div>
    </div>
  );
}
